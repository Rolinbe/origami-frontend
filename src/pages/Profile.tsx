    ...
    <AppLayout>
      <div className="mx-auto max-w-3xl space-y-6">
        <PageHeader
          icon={UserRound}
          title="Mon profil"
          description="Consultez et modifiez vos informations personnelles et votre mot de passe."
        />
            ...
            <form className="space-y-8" onSubmit={handleSubmit}>
              <div className="flex items-center gap-4">
                <div className="relative">
                  <div className="h-20 w-20 overflow-hidden rounded-full border-2 border-muted bg-muted flex items-center justify-center">
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    C'est votre identifiant de connexion. Après modification, utilisez le
                    nouvel email pour vous connecter.
                  </p>
                </div>
                <div className="space-y-2">
